+++
title = "Interval Arithmetic: Paper Review"
description = "A review of the paper 'Interval Arithmetic: from Principles to Implementation'"
date = 2025-11-13

[taxonomies]
tags = ["oneil", "paper-review", "interval-arithmetic"]
...
[interval arithmetic experiment](https://github.com/pixilcode/interval-arithmetic-analysis)
previously, although my approach was less formalized than here.
